...
export default function CalendarView() {
  ...
  return (
    <div className="calendar-page" style={{ minHeight: '100vh', backgroundColor: '#F8F9FA' , padding: '40px'}}>
      {/* Header */}
          ...
          >
            ...
            <div style={{ marginBottom: '24px' }}>
              ...
              <div style={{ display: 'flex', gap: '8px' }}>
                ...
                <button
                  onClick={() => copyToClipboard(teamCalendarUrl, 'team')}
                  style={{
                    backgroundColor: copied === 'team' ? '#22c55e' : '#f1f5f9',
                    color: copied === 'team' ? 'white' : '#002349',
                    padding: '12px 16px',
                    fontSize: '13px',
                    fontWeight: 600,
                    border: 'none',
            ...
            {myCalendarUrl && (
              <div style={{ marginBottom: '24px' }}>
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                  ...
                  <button
                    onClick={() => copyToClipboard(myCalendarUrl, 'my')}
                    style={{
                      backgroundColor: copied === 'my' ? '#22c55e' : '#f1f5f9',
                      color: copied === 'my' ? 'white' : '#002349',
                      padding: '12px 16px',
                      fontSize: '13px',
                      fontWeight: 600,
                      border: 'none',
